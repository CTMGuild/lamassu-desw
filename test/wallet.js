...
var REQUIRED_MOCK_PROPERTIES = ['wif', 'serverKey', 'baseURL', 'dest_address'];
  ...
  describe(plugin.NAME + ' Wallet', function() {
    ...
    describe('Requests', function() {
      ...
      it('should fail to send bitcoins to an invalid address', function(done) {
        plugin.sendBitcoins('1abc', 0.0001 * 1e8, null, function(err) {
          should.exist(err);
      ...
      it('should fail to send 0 bitcoins', function(done) {
        plugin.sendBitcoins(configMock.dest_address, 0, null, function(err, resp) {
          should.exist(err);
      ...
      it('should successfully send bitcoins', function(done) {
        plugin.sendBitcoins(configMock.dest_address, 0.0001 * 1e8, null, function(err, did) {
          should.not.exist(err);

	      // did is a debit id from DeSW.
          did.should.be.a('number');
